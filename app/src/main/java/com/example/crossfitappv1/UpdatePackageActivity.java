...
public class UpdatePackageActivity extends AppCompatActivity {
    ...
    private ImageView updatePackageImage;
    private EditText txtName,txtDes,txtAvailableDate,txtExpireDate;
    private Button updatePackageBtn,deletePackageBtn;

    private String name,description,availableDate,expireDate,image;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        availableDate = getIntent().getStringExtra("availableDate");
        ...
        try {
            Picasso.get().load(image).into(updatePackageImage);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        txtAvailableDate.setText(availableDate);
        txtExpireDate.setText(expireDate);

        updatePackageImage.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void deleteData() {
        ...
        .addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                Toast.makeText(UpdatePackageActivity.this,"Package deleted successfully", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(UpdatePackageActivity.this,AdminCategory.class);
            ...
            public void onFailure(@NonNull Exception e) {
                    Toast.makeText(UpdatePackageActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void updateData(String s) {
        ...
        hp.put("availableDate",availableDate);
        hp.put("expireDate",expireDate);
        hp.put("image",s);
        ...
        public void onSuccess(Object o) {
                Toast.makeText(UpdatePackageActivity.this,"Package updated successfully", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(UpdatePackageActivity.this,AdminCategory.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
    ...
    private void uploadImage(){
        ...
        uploadTask.addOnCompleteListener(UpdatePackageActivity.this, new OnCompleteListener<UploadTask.TaskSnapshot>() {
            @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data){
        ...
        if(requestCode == REQ && resultCode == RESULT_OK){
            ...
            updatePackageImage.setImageBitmap(bitmap);
        }
    }
}