...
public class PackageAdapter extends RecyclerView.Adapter<PackageAdapter.PackageViewAdapter>{
    private List<categoryData> list;
    private Context context;
    private String category;

    public PackageAdapter(List<categoryData> list, Context context, String category) {
        this.list = list;
    ...
    public class PackageViewAdapter extends RecyclerView.ViewHolder {
        ...
        public PackageViewAdapter(@NonNull View itemView){
            ...
            update = itemView.findViewById(R.id.packageUpdate);
