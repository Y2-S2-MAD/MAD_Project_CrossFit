...
public class AdminStoreCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_store_category);
        ...
        fab.setOnClickListener((view) -> {
                startActivity(new Intent(AdminStoreCategory.this,AddStoreCategory.class));
        });
    }
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (!dataSnapshot.exists()){
                        ...
                        protein.setLayoutManager(new LinearLayoutManager(AdminStoreCategory.this));
                        adapter = new StoreAdapter(list1,AdminStoreCategory.this,"Protein");
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(AdminStoreCategory.this,databaseError.getMessage(),Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    fitnessAcc.setLayoutManager(new LinearLayoutManager(AdminStoreCategory.this));
                    adapter = new StoreAdapter(list2,AdminStoreCategory.this,"Fitness Accessories");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    creatine.setLayoutManager(new LinearLayoutManager(AdminStoreCategory.this));
                    adapter = new StoreAdapter(list3,AdminStoreCategory.this,"Creatine");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()){
                    ...
                    fatBurns.setLayoutManager(new LinearLayoutManager(AdminStoreCategory.this));
                    adapter = new StoreAdapter(list4,AdminStoreCategory.this,"Fat Burns");
