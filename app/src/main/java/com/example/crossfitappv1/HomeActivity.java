...
public class HomeActivity extends AppCompatActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    //comment
    CardView FoodCard,ExerciseCard,PackageCard;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PackageCard = (CardView) findViewById(R.id.user_package_card);

        FoodCard.setOnClickListener(this);
        ExerciseCard.setOnClickListener(this);
        PackageCard.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.user_package_card:
                i = new Intent(this,userCategory.class);
                startActivity(i);
                break;
        }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.nav_package:
                Intent intent3 = new Intent(HomeActivity.this,userCategory.class);
